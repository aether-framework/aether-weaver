...
Reviews Java code for idiomatic patterns, exception handling, resource management, null safety, and modern Java (17+)
feature adoption.
...
ProcessingException("File read error",e);
}
...
Throwable t){  // Catches OutOfMemoryError, StackOverflowError
        log.
...
add("string");  // No compile error, runtime issue
...
close();  // NPE if exception in constructor
}
